...
To run the modpack:
 - To update the core mod, CoreboundCore, you need to run the gradlew modrinth command which builds the mod jar in an unlisted [modrinth mod](https://modrinth.com/mod/coreboundcore) which packwiz can fetch from
    - For more information, check the mod repo [README](https://github.com/linmjie/CoreboundCore/blob/main/README.md)
